...
const saveProductByID = async (req, res) => {
    ...
    const {arrayProductsIds} = req.body // escribimos en el body los ids de los productos para agregarlos al carrito
    ...
    try {
        ...
        if(cartIndex != -1){
            ...
            if(dataProducts.length != 0){
                ...
                databaseDataCart[cartIndex].products = concatData // si ya hay productos en un carrito, los concatena
